...
static void sandybridge_setup_bars(void)
{
	...
	pci_write_config32(PCI_DEV(0, 0x00, 0), PCIEXBAR, (uintptr_t)DEFAULT_PCIEXBAR | 5); /* 64MB - busses 0-63 */
	pci_write_config32(PCI_DEV(0, 0x00, 0), PCIEXBAR + 4, (0LL+(uintptr_t)DEFAULT_PCIEXBAR) >> 32);
