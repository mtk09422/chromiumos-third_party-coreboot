...
#define GPIO_EXT_BUCK_EN_B_PIN_M_GPIO  GPIO_MODE_00
...
#define GPIO_USB_HUB_HX3_RESET_L_PIN        (GPIO101 | 0x80000000)
#define GPIO_USB_HUB_HX3_RESET_L_PIN_M_GPIO GPIO_MODE_00
