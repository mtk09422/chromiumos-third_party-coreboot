...
static void lcd_init(void)
{
	...
	val = readl((void *)ASIU_TOP_LCD_AXI_SB_CTRL);
	...
	writel(val, (void *)ASIU_TOP_LCD_AXI_SB_CTRL);
...
static void v3d_init(void)
{
	...
	val = readl((void *)ASIU_TOP_GFX_AXI_SB_CTRL);
	/*
	...
	writel(val, (void *)ASIU_TOP_GFX_AXI_SB_CTRL);
