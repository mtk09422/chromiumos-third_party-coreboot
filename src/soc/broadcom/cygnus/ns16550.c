...
static const struct console_driver cygnus_uart_console __console = {
	.init     = ns16550_init,
	.tx_byte  = ns16550_tx_byte,
	.tx_flush = ns16550_tx_flush,
	.rx_byte  = ns16550_rx_byte,
	.tst_byte = ns16550_tst_byte,
};
