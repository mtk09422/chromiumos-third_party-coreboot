...
{
	uint32_t reg;
	u32 *pconf0_addr = score_pconf0(pad);
...
{
	uint32_t reg;
	u32 *pconf0_addr = ssus_pconf0(pad);
...
{
	u32 *val_addr = score_pconf0(pad) + PAD_VAL_REG/sizeof(u32);
...
{
	u32 *val_addr = ssus_pconf0(pad) + PAD_VAL_REG/sizeof(u32);
