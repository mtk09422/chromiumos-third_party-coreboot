 ...
 */
#define GPIO_SKL_LP_GROUP_A		0x0
#define GPIO_SKL_LP_GROUP_B		0x1
#define GPIO_SKL_LP_GROUP_C		0x2
#define GPIO_SKL_LP_GROUP_D		0x3
#define GPIO_SKL_LP_GROUP_E		0x4
#define GPIO_SKL_LP_GROUP_F		0x5
#define GPIO_SKL_LP_GROUP_G		0x6
...
/*
 * SKL LP GPIO pins Use below for functions from PCH GPIO Lib which
