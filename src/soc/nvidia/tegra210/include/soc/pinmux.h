...
enum {
	...
	PAD_NO_GPIO(149, GPIO_PK0, POR_PD, IQC0, I2S5B, RES2, RES3),
	PAD_NO_GPIO(150, GPIO_PK1, POR_PD, IQC0, I2S5B, RES2, RES3),
	PAD_NO_GPIO(151, GPIO_PK2, POR_PD, IQC0, I2S5B, RES2, RES3),
	...
	PAD_NO_GPIO(160, GPIO_PZ1, POR_PD, VIMCLK2, SDMMC1, RES2, RES3),
	PAD_NO_GPIO(161, GPIO_PZ2, POR_PD, SDMMC3, CCLA, RES2, RES3),
	PAD_NO_GPIO(162, GPIO_PZ3, POR_PD, SDMMC3, RES1, RES2, RES3),
	PAD_NO_GPIO(163, GPIO_PZ4, POR_PD, SDMMC1, RES1, RES2, RES3),
