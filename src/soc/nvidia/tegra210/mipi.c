...
static const struct calibration_regs tegra210_mipi_calibration_regs[] = {
...
static const struct tegra_mipi_config tegra210_mipi_config = {
	.calibrate_clk_lane = 1,
	.regs = tegra210_mipi_calibration_regs,
	.num_pads = ARRAY_SIZE(tegra210_mipi_calibration_regs),
};
						...
						int device_index)
{
	...
	device->config = &tegra210_mipi_config;
