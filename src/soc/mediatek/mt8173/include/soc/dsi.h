...
enum {
	DSI_PHY_TIMECON0 = 0x0110,
	DSI_PHY_TIMECON1 = 0x0114,
	DSI_PHY_TIMECON2 = 0x0118,
	DSI_PHY_TIMECON3 = 0x011C
};
...
enum {
	...
	MIPITX_DSI_PLL_CON3	= 0x5C,
	MIPITX_DSI_PLL_TOP	= 0x60,
	MIPITX_DSI_RGS		= 0x64,
	MIPITX_DSI_GPIO_EN	= 0x68,
	MIPITX_DSI_GPIO_OUT	= 0x6c,
	MIPITX_DSI_SW_CTRL	= 0x80,
	MIPITX_DSI_SW_CTRL_CON0	= 0x84,
	MIPITX_DSI_SW_CTRL_CON1	= 0x88,
	MIPITX_DSI0_MPPLL_SDM_CON1 = 0x90,
	MIPITX_DSI0_MPPLL_SDM_CON2 = 0x94
};
...
/* MIPITX_DSI0_MPPLL_SDM_CON1 */
enum {
	RG_DSI0_MPPLL_ISO_EN =	(1),
	RG_BY_ISO_DLY	= (1<<1),
	RG_DSI0_MPPLL_PWR_ON = (1<<2),
	RG_BY_PWR_DLY	     = (1<<3),
	RSV_ATPG_CON         = (1<<4),
	DSI0_MPPLL_PWR_ACK   = (1<<24)
};
