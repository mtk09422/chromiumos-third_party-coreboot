...
#ifndef SOC_MEDIATEK_MT8135_BLKDEV_H
#define SOC_MEDIATEK_MT8135_BLKDEV_H
...
struct blkdev {
	...
	int (*bread)(struct blkdev *bdev, u32 blknr, u32 blks, u8 *buf);
	int (*bwrite)(struct blkdev *bdev, u32 blknr, u32 blks, u8 *buf);
};
...
#endif /* SOC_MEDIATEK_MT8135_BLKDEV_H */
