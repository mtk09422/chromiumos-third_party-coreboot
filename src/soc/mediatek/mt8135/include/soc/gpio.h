#ifndef SOC_MEDIATEK_MT8135_GPIO_H
#define SOC_MEDIATEK_MT8135_GPIO_H
...
typedef enum GPIO_PIN {
	...
	GPIOEXT7, GPIOEXT8, GPIOEXT9, GPIOEXT10, GPIOEXT11, GPIOEXT12, GPIOEXT13,
	GPIOEXT14, GPIOEXT15, GPIOEXT16, GPIOEXT17, GPIOEXT18, GPIOEXT19, GPIOEXT20,
	GPIOEXT21, GPIOEXT22, GPIOEXT23, GPIOEXT24, GPIOEXT25, GPIOEXT26, GPIOEXT27,
	GPIOEXT28, GPIOEXT29, GPIOEXT30, GPIOEXT31, GPIOEXT32, GPIOEXT33, GPIOEXT34,
	GPIOEXT35, GPIOEXT36, GPIOEXT37, GPIOEXT38, GPIOEXT39, GPIOEXT40, GPIO_MAX
} GPIO_PIN;

#define MAX_GPIO_PIN    (GPIO_MAX)
#define GPIO_EXTEND_START GPIOEXT0
typedef enum GPIO_PIN_EXT {
	GPIO203 = GPIO_EXTEND_START,
	GPIO204, GPIO205, GPIO206, GPIO207, GPIO208, GPIO209, GPIO210, GPIO211,
	GPIO212, GPIO213, GPIO214, GPIO215, GPIO216, GPIO217, GPIO218, GPIO219,
	GPIO220, GPIO221, GPIO222, GPIO223, GPIO224, GPIO225, GPIO226, GPIO227,
	GPIO228, GPIO229, GPIO230, GPIO231, GPIO232,
	GPIO233, GPIO234, GPIO235, GPIO236, GPIO237, GPIO238, GPIO239,
	GPIO240, GPIO241, GPIO242, GPIO243
} GPIO_PIN_EXT;
 ...
 * set driving
 * pin:GPIO0~GPIO202
 * driving:  group 0(2,4,6,8,10,12,14,16)
 *           group 1(4,8,12,16)
 *           group 2(2,4,6,8)
 *           group 3(4,8,12,16,20,24,28,32)
 *           group 4 invalid
 * pin were divided into four groups, set register based
 * on their address and flag follow "pin_group"
 */
...
#endif /* SOC_MEDIATEK_MT8135_GPIO_H */
